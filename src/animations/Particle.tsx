...
const fragment = /* glsl */ `
  ...
  void main() {
    ...
    if(uAlphaParticles < 0.5) {
      ...
      // Perubahan di sini: smoothstep 0.48 membuat pinggiran lebih tajam (tebal)
      // Multiplier 1.0 (sebelumnya 0.8) meningkatkan kepekatan warna
      float circle = smoothstep(0.5, 0.48, d) * 1.0; 
...
const Particles: React.FC<ParticlesProps> = ({
  particleCount = 500, // Naik dari 200
  particleSpread = 10,
  speed = 0.1,
  particleColors,
